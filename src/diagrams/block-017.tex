...
\begin{figure}[H]
  ...
  \begin{center}
    \begin{tikzpicture}[auto, scale=1.0, every node/.style={transform shape}, node distance=3cm,>=latex']
      ...
      \node [draw=black, label=below:{\shortstack[c]{GHV Equations\\ of Motion}}, label=above:{$A,B\Lambda,C$}, minimum width=2cm, inner sep=0mm] (R1){\includegraphics[width=4cm]{../fig/ghvclouds.pdf}}; \\
      };
